...
import com.example.kokomputer.databinding.ActivityDetailMenuBinding
    ...
    private fun addToCart(){
        viewModel.addToCart().observe(this){
            it.proceedWhen(
                doOnSuccess = {
                    Toast.makeText(this,
                        getString(R.string.text_successfully_add_product_to_cart), Toast.LENGTH_SHORT).show()
                    finish()
                },
                doOnError = {
                    Toast.makeText(this,
                        getString(R.string.text_failed_add_product_to_cart), Toast.LENGTH_SHORT).show()
                }
            )
        }
    }
